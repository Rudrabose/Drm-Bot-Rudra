...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7048600886:AAHplrOY73kdFZI7gq9Khftvj-iSqUO-yDs")
    API_ID = int(os.environ.get("API_ID",  "1324937"))
    API_HASH = os.environ.get("API_HASH", "e915776334fc44d2c86fa3be3cbf8552")
    DOWNLOAD_LOCATION = "./DOWNLOADS"
    SESSIONS = "./SESSIONS"

    AUTH_USERS = os.environ.get('AUTH_USERS', '5729628706').split(',')
    ...
    LOG_CH = os.environ.get("LOG_CH", "-1002028253906")
...
if __name__ == "__main__":
    ...
    async def main():
        await PRO.start()
        # h = await PRO.get_chat_member(chat_id= int(-1002028253906), user_id=5729628706)
        # print(h)
